...
def get_parser():
    ...
    parser.add_argument("--n_batches", type=int,
                        default=-1, help="number of batches of training")
    parser.add_argument("--n_checkpoints", default=-1, type=int,
                        help="number of checkpoints during training (if used dominates checkpoint_interval)")
    ...
    parser.add_argument("--report_freq", type=int, default=10,
                        help='report frequency determines how often the loss is printed')
    parser.add_argument("--model_path", type=str, default="saved_models",
                        help="where the model is saved/should be saved")
...
def main(opt):
    ...
    discriminator = Discriminator(
        input_shape=(opt.channels, *hr_shape)).to(device)
